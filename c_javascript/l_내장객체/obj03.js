...
//% 4. Math 낸장 객체: 수학과 관련된 기본 여산 객체

console.log(`원주율 값: ${Math.PI}`); // 원주율 값: 3.141592653589793

console.log(`0이상 1미만의 난수 생성: ${Math.random()}`);
// console.log(`0이상 1미만의 난수 생성: ${Math.random() * N}`);
console.log(`0이상 1미만의 난수 생성: ${Math.random() * 10}`);

console.log(`소수점 자리 내일: ${Math.floor(Math.random() * 10)}`);
...
let now = new Date();
console.log(now); //2025-10-20T03:13:06.147Z (한국 UTC 9시간 빠름: UTC+9)
...
console.log(current); // 2025-10-20T03:23:25.460Z

// 요일 배열 정의
const days = ['SUN', 'MON', 'TUE', 'WED', 'THU', 'FRI', 'SAT'];

// getDay()로 인덱를 받아, 배열에서 요일 문자열 추출
