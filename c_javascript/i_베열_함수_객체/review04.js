...
// 학생 추가 예제
gradeSystem.addStudent("샛빨강", { Math: 90, English: 85, Science: 78 });
gradeSystem.addStudent("샛노랑", { Math: 80, English: 95, Science: 88 });
gradeSystem.addStudent("샛초록", { Math: 85, English: 100, Science: 65 });
gradeSystem.addStudent("샛파랑", { Math: 70, English: 80, Science: 87 });
