...
busanLibrary.addBook('자바스크립트 공부는 재밌어', '노랑색');
busanLibrary.addBook('자바 공부는 재밌어', '초록색');
busanLibrary.addBook('SQLD 공부는 재밌어', '파랑색');
busanLibrary.addBook('타입스크립트 공부는 재밌어', '빨강색');
busanLibrary.addBook('리액트 공부는 재밌어', '보라색');
...
yangsanLibrary.addBook('자바스크립트 공부는 재밌어', '노랑색');
yangsanLibrary.addBook('자바 공부는 재밌어', '초록색');
yangsanLibrary.addBook('SQLD 공부는 재밌어', '파랑색');
yangsanLibrary.addBook('타입스크립트 공부는 재밌어', '빨강색');
yangsanLibrary.addBook('리액트 공부는 재밌어', '보라색');

yangsanLibrary.displayBook();

yangsanLibrary.filterBooksByAuthor('노랑색');
