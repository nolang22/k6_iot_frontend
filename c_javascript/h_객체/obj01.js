...
function Human(nameParam, ageParam) {
  ...
  // this는 현재 객체 그 자체
  // : 좌항의 .name / .age와 같이 해당 객체 내의 속성에 접근하여고할 때
  //    , 해당 필드(프로퍼티)가 생성(선언)
  this.name = nameParam;
  this.age = ageParam;
...
let person1 = new Human('노랑색', 22);
let person2 = new Human('초록색', 33);

person1.greet(); // Hello, 노랑색
person2.greet(); // Hello, 초록색
