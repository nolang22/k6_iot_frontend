...
const person1 = new Person('노랑색'); // this가 person1 (person1.name === 노랑색)
const person2 = new Person('초록색'); // this가 person2 (person1.name === 초록색)

console.log(person1.name); // 노랑색
console.log(person2.name); // 초록색
