...
/*
* JS의 canvas 요소
  : THML5dml <canvas> 태그를 이용하여 JavaScript로 동적인 그래픽을 그리는 기술
...
canvas.width = 800;
canvas.height = 500;
//* 6) 2D 그리기 컨텍스트 가져오기 (캔버스 영역을 JS을 JS로 가져오기)
...
app === null || app === void 0 ? void 0 : app.appendChild(createToolbat());
