...
//? cf) 타입 별칭(type alias)
// : 데이터 타입 명시
// - 원시 타입, 유니언, 인터섹션 등의 모든 타입을 별칭으로 지정 가능
type UserType = {
  name: string;
  age: number;
};
...
const student1 = new Student("샛노랑", 22); // this.name === '샛노랑'
student1.greet("샛초록"); // Hello1, my name is 샛초록
                         // Hello2, my name is 샛노랑

const student2 = new Student("샛빨강", 11);
student2.greet("샛파랑"); // Hello1, my name is 샛파랑
                         // Hello2, my name is 샛빨강
