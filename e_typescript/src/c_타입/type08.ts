...
// : "개발자" TS 컴파일러(tsc) 보다 데이터 타입의 주도권을 가지는 방법
// - 컴파일러에게 '이 데이터의 타입을 내가! 지정한 타입으로 간주해라'라는 자시
...
//      리턴받은 DOM 객체의 타입은 HTMLElement 타입!
...
const jsonString = '{"name": "SNL", "age": 22}';
