...
2. "Lodin user data" 메시지 출력
3. 실제 데이터 요청이 실행 후 완료 시 사용자 데이터가 화면에 표기
...
fetchButton === null || fetchButton === void 0 ? void 0 : fetchButton.addEventListener("click", function () { return __awaiter(_this, void 0, void 0, function () {
    var userDataDiv, userId, apiUrl, fetchResponse, user, e_1;
...
userIdElement.addEventListener("keydown", function (e) { return __awaiter(_this, void 0, void 0, function () {
    var userDataDiv, userIdElement_1, userId, apiUrl, fetchResponse, user, e_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!(e.key === "Enter")) return [3 /*break*/, 5];
                userDataDiv = document.getElementById("userData");
                userIdElement_1 = document.getElementById("userId");
                userId = userIdElement_1 ? userIdElement_1.value : "";
                apiUrl = "https://jsonplaceholder.typicode.com/users/".concat(userId);
                if (!userDataDiv) return [3 /*break*/, 5];
                userDataDiv.innerHTML = "<p>Loading user data</p>";
                _a.label = 1;
            ...
            case 4:
                e_2 = _a.sent();
                //? 데이터 처리 실패 시 메시지 출력
                userDataDiv.innerHTML = "<p>".concat(e_2, "</p>");
                return [3 /*break*/, 5];
            case 5: return [2 /*return*/];
        }
    });
