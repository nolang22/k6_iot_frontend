...
// 3) 다지인 설계 없이는 똑같은 UI만 복사
// : 다지인 시스템 없이 사용하면 'tailwind를 사용한 일반 CSS와 다름없음'
...
function C_Tailwind() {
  return (
    <div>
      ...
      rounded-lg'>tailwind CSS 적용한 버튼</button>

      <button className='text-sm md:text-base lg:text-xl'>한 요소에서 모든 반응형 처리 가능</button>
    </div>
  )
}
