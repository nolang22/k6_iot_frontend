...
//    EX) { "name": "샛노랑", "email": "nolang22" }

/*
  POST /users HTTP/1.1
  Host: api.example.com
  Content-Type: application/json - "JSON 형식으로 보냄"
  Authorization: Bearer abd123token - "로그인한 사용자의 토큰"
...
//* REST(Representational State Transfoer) 스타일
...
//    : 일부 오래된 시스템 또는 프레임워크는 PTCH를 지원하지 X - PUT으로 통일하여 사용
