...
//* CSS Module
// : 전역적인 CSS 적용 X, 컴포넌트 단위로 CSS를 적성하는 기능 (모듈화)
  ...
  return (
    <button
      ...
      className={`${styles.button} ${
        variant === "secondary" ? styles.secondray : ""
      }`}
    >
...
// 2) 주요 목적: 복잡한 카드 / 대시보드 / 갤러리 에이아웃 구성
// 3) 적용 대상: display: grid;를 가진 부모 컨테이너

//% 기본 속성 정이
// display: grid; - 그리드 컨테이너 활성화
// grid-template-colmns - 열 개수 / 크기 정의 EX) repeat(3, 1fr)
  ...
  return (
    <>
      <section className={gridStyles.dashboard}>
        <h3>오늘 예약 현황</h3>
        <div className={gridStyles.status}>
