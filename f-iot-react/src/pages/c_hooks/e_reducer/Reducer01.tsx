...
//* == React 컴포넌트의 상태 관리 (useStatae VS useReducer) ==
...
// > 컴포넌트 내부에서 바로 상태를 변경하는 상태 변경 함수으(set-)를 호출
...
// - redeucer: 리듀서 함수(상태를 어떻게 변경할지 정의한 함수)
//   >> Reducer의 인자로 전달되는 함수
//   >> 상태 변경 로직을 포함(swich, case)하고
