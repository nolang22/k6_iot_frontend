...
function State01() {
  ...
  // - 여러 개의 상태 사용 시 ,관련 있는 훅 끼리 묶어서 컴포넌트 상단에 배치 -> 가독성 향상
  ...
  const [message, setMessage] = useState<string>('안녕하쇼요');
  // if (true) {
  const [msg, setMsg] = useState<string>('반갑숩니다');
  // }
