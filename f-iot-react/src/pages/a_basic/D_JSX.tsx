...
/*
* JSX(TSX)
  : JS(TS) 파일 내에서 HTML과 유사한 마크업을 자것ㅇ할 수 있도록 해주는 JS 구문 확장 문법

? 사용 목족
- 선언적 뷰 설계 사능 (UI를 직관적으로 설계)
- 불필요한 DOM 설정 필요 X

? 특징
- JS + HTML(XML) 형태로 엄격한 문법 체계
- JSX 내에서 HTML 코드와 JS 코드를 분리 변환할려면 XML 문법을 준수
  ...
  return (
    <>
      ...
      */}
      ...
      {/* 
        ? 요소에 이벤트 전달시
        : 코드를 해석하는 과정에서 실행되지 않도록 '콜백 함수의 형채로 전달' 
        - 익명함수의 형태
