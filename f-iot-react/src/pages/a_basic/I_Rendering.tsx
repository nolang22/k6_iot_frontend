...
function I_Rendering() {
  ...
  const people = ['샛빨강', '샛노랑', '샛초록', '샛파랑', '샛보라'];
  ...
  //* == React 렌더링 시 key 속성 == //
  // : React에서 배열의 각 항ㅁ고을 식별하고 성능을 최적화하기 위해 사용
