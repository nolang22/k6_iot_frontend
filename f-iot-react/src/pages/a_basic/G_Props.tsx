...
function MultiProps(props: { name: string; colorProps: string;}) {
  ...
  // props.name = 'SAES NO LANG'; - 읽기 전용 속성
...
function MultiProps2({name = '샛초록', colorProps}: Multi2Type) {
  return (
...
function G_props() {
  ...
  return (
    <Wrapper>
      <ChildComponent name='샛노랑' />
      <ChildComponent2 name='샛초록' />

      <MultiProps name='샛파랑' colorProps='lightblue' />
      <MultiProps2 name='샛보라' colorProps='purple' />
