...
//    > 매번 API 호출 X, 한 번 불러온 데이터를 전역에 저장학 사용 (효율적)
...
export const useGlobalStore = create<GlobalStata>((set) => ({
  // 속성값과 함수를 정의
  // - 속성값: 초기값 할당
  ...
  fetchGlobalData: async () => {
    try {
      ...
      //   regions: commonDatas.categories,
      //   isLoaded: true,
      // });

      set({
        categories: [ "CORRFF", "DESSERT", "DRINKS", "FOODS" ],
