...
// B. 컴포넌트의 상태(state)를 관리하기 위해 ㅇㅇㅇㅇㅇ
...
// A. 일반 함수 내부
// B. 클래스 메서드 내부
// C. React 함수형 컴포넌트 또는 커스텀 훅 내부  ㅇㅇㅇㅊㅇㅇ
// D. JSX 블록 내부

//? 3. useState의 반환값 형태는?
// A. 단일 값
// B. [상태값, 상태변경함수] 배열   ㅇㅇㅇㅇㅇ
// C. 객체 {state, setState}
// D. Promise 객체
...
// C. 배열 구조분해를 사용할 수 없음 ㅇㅇㅇㅇㅇ
// D. setCount는 예약어라 사용할 수 없음

//? 5. useState로 관리되는 값이 변경되면 어떤 일이 일어나는가?
// A. DOM이 직접 갱신됨
// B. 해당 컴포넌트가 다시 렌더링됨  ㅇㅇㅇㅇㅇ 
// C. 전역 상태가 초기화됨
// D. 아무 일도 일어나지 않음 

//? 6. 초기 상태를 함수로 전달할 수 있다. (O/X) ㅇㅇㅇㅇ

//? 7. useState로 관리하는 상태는 불변성을 유지해야 한다. (O/X) ㄴㄴㄴㄴㄴㄴ
...
// B. 객체는 직접 수정해야 한다   ㅇㅇㅇㅇㅇ
// C. setUser는 숫자만 받는다
// D. ... 연산자는 JSX에서만 사용 가능하다

//? 10. useState의 상태 업데이트 함수(setState)는 비동기적으로 동작할 수 있다. (O/X)  ㅇㅇㅇㅇ