...
//? 5. useRef는 값이 변경되어도 컴포넌트를 다시 렌더링하지 않는다. (O/X) ㄴㄴㄴㄴㄴ

//? 6. useRef는 렌더 간에 유지되는 "가변 변수" 역할을 한다. (O/X) ㅇㅇㅇㅇ
...
// B. 상태 관리 및 재렌더링 최적화 시   ㅇㅇㅇㅇㅇ
// C. API 호출 로직 처리 시
// D. CSS 애니메이션 제어 전용 시

//? 9. useRef로 이전 렌더의 값을 저장할 수 있다. (O/X)  ㅇㅇㅇㅇㅇ

//? 10. useRef는 React 렌더 주기 사이에서도 동일한 객체를 유지한다. (O/X) ㄴㄴㄴㄴ